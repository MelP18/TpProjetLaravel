<form method="POST"  action="{{ route('addStudentInfo') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div class="main__details__student">
            <div class="student__information__top">
                ...
                <div class="student__information">
                    ...
                    <div class="information">
                        <h4>Hobbies : </h4>
                        <div class="field">
                            <input value="{{old('hobby')}}" type="text" name="hobby">
                        </div> 
                    </div>
                    <div class="information">
                        <h4>Spécialité : </h4>
                        <div class="field">
                            <input value="{{old('speciality')}}" type="text" name="speciality">
                        </div>
                    </div>
                    <div class="information">
                        <h4>Compétences : </h4>
                        <div class="field">
                            <input value="{{old('competency')}}" type="text" name="competency">
                        </div>   
                    </div>
                </div>
            </div>
            <div class="student__information__bottom">
                ...
                <div class="student__biographie">
                    <textarea value="{{old('biography')}}" name="biography" id="" cols="" rows="5"></textarea>
                </div>
            </div>
